...
function CreateEditInvoiceItem({
  ...
  return (
    <div className="grid grid-cols-[4fr_8rem_2fr_2fr_1fr] items-center gap-6 pb-6">
      <input
        type="text"
        id="itemName"
      ...
      <input
        type="number"
        id="qty"
        className="w-full rounded-[0.4rem] border border-solid border-[#dfe3fa] bg-transparent px-4 py-6 text-[1.5rem] font-bold leading-[1.5rem] tracking-[-0.025rem] text-[#0c0e16] focus:border focus:border-[#9277ff] focus:outline-none"
        placeholder="Qty."
        defaultValue={qty}
